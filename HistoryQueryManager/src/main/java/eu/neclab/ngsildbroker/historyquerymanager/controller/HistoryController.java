...
public class HistoryController {
	...
	@GET
	@Blocking
	@Counted(value = "temp_entity_query_total", description = "Total number of temp entity query requests")
	@Timed(value = "temp_entity_query_duration", description = "Duration of temp entity query requests")
	@Timed(value = "temp_entity_query_concurrent", longTask = true, description = "Number of concurrent temp entity query requests")
	...
	@Path("/{entityId}")
	@GET
	@Counted(value = "temp_entity_retrieve_total", description = "Total number of temp entity retrieve requests")
	@Timed(value = "temp_entity_retrieve_duration", description = "Duration of temp entity retrieve requests")
	@Timed(value = "temp_entity_retrieve_concurrent", longTask = true, description = "Number of concurrent temp entity retrieve requests")
