...
| `app.image` | The container image to use. | docker.io/dev/registry-subscription-manager:7.0.0 |
...
| `app.ports.http` | The http port to use for the probe. | 10094 |
