...
public interface NGSIConstants {
	...
	public final static String QUERY_PARAMETER_OPTIONS_AGGR_VALUES = "aggregatedValues";
	...
	public final static Set<String> ALLOWED_OPTIONS = Sets.newHashSet(QUERY_PARAMETER_OPTIONS_NORMALIZED,
			QUERY_PARAMETER_OPTIONS_SYSATTRS, QUERY_PARAMETER_CONCISE_VALUE, QUERY_PARAMETER_OPTIONS_AGGR_VALUES,
	...
	public static final String CSOURCE_NOTIFICATION = "ContextSourceNotification";
	...
	public static final String ENDPOINT_SOURCE_IDENTITY = "/ngsi-ld/v1/info/sourceIdentity";
	...
	public static final Set<String> ATTR_BASE_PROPS = Sets.newHashSet(JSON_LD_TYPE, NGSI_LD_CREATED_AT,
			NGSI_LD_MODIFIED_AT, NGSI_LD_OBSERVED_AT, NGSI_LD_OBJECT_TYPE, NGSI_LD_DATA_SET_ID, NGSI_LD_UNIT_CODE);
